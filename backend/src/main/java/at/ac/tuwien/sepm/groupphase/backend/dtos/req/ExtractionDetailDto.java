...
public class ExtractionDetailDto {
    ...
    public ExtractionDetailDto(Long id, LocalDateTime dateTime, ExtractionBrewMethod brewMethod, CoffeeGrindSetting grindSetting,
                               Double waterTemperature, Double dose, Duration brewTime, Integer body, Integer acidity, Integer aromatics,
                               Integer sweetness, Integer aftertaste, String ratingNotes, Integer overallRating, Long beanId) {
        this.id = id;
